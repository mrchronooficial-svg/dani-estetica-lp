...
export const CTA_SUBTEXT = "R$197 ou 12x de R$19,70 · Garantia incondicional de 7 dias";
...
export const POR_QUE_FUNCIONA = [
  {
    num: "01",
    title: "Seu Inchaço Não É Gordura — É Fluido Retido",
    text: "Aquele inchaço que você sente toda manhã não é gordura. O corpo humano é mais de 50% água, e quando seu sistema linfático não drena esse líquido de forma eficiente, o resultado é inchaço, peso e desconforto. A automassagem ativa essa drenagem manualmente.",
  },
  {
    num: "02",
  ...
  {
    num: "05",
    title: "Prazer no Lugar de Sofrimento",
    text: "Enquanto dietas pedem restrição e academia pede esforço, automassagem é relaxamento, autocuidado e prazer. Você cuida do corpo enquanto cuida de si.",
  },
  {
    num: "06",
    title: "21 Dias Criam um Hábito",
    text: "Na primeira semana, seu corpo desincha e começa a responder. Na segunda, as medidas começam a cair. Na terceira, a técnica já virou hábito e os resultados se acumulam. 21 dias é o tempo mínimo pra criar uma rotina que fica.",
  },
];
...
export const MODULOS = [
  {
    num: 1,
    title: "Preparação + Introdução",
    desc: "Este módulo é a sua base. Aqui, a Dani vai te dar as instruções exatas para começar com o pé direito.",
    items: [
    ...
    result: "Você vai entender exatamente como funciona e preparar seu corpo para os 21 dias de transformação.",
  },
  {
    num: 2,
    ...
    result: "Pernas mais leves, definidas e glúteos visivelmente mais firmes em 7 dias.",
  },
  {
    num: 3,
    title: "Semana 2 — Abdômen",
    desc: "O módulo mais desejado. Foco na região nº1 de insatisfação feminina.",
    items: [
    ...
    result: "Barriga visivelmente menos inchada e cintura mais definida.",
  },
  {
    num: 4,
    title: "Semana 3 — Braços + Corpo Completo",
    desc: "O módulo que fecha o ciclo e consolida todos os resultados.",
    items: ["Mãos", "Braços"],
    result: "Silhueta completa modelada. Corpo inteiro transformado em 21 dias.",
  },
];
...
export const BONUS = [
  {
    num: 1,
    title: "Protocolo Rosto de Cristal",
    desc: "Técnica de rolo de gelo para firmeza e rejuvenescimento facial. Desinche o rosto, reduza olheiras e tenha uma pele mais firme e luminosa em poucos minutos.",
    value: 97,
  },
  {
    num: 2,
  ...
  {
    num: 3,
    title: "Guia Desincha Já — com Nutricionista",
    desc: "Alimentação anti-inchaço + dicas exclusivas com nutricionista. Descubra quais alimentos estão te inchando e quais vão potencializar sua drenagem.",
    value: 127,
  },
  {
    num: 4,
    title: "Hidratação Profunda Pro",
    desc: "Protocolo profissional de hidratação corporal que deixa sua pele de seda. O complemento perfeito para a automassagem.",
    value: 67,
  },
];
